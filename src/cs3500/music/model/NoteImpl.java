...
public class NoteImpl implements INote {
   ...
   * @param beat      The beat of this note, including the start beat.
   * @param startTime The note starts on this beat.
   * @param volume The volume of this note.
   * @param instrument The instrument used in this note.
   */
  public NoteImpl(Pitch pitch, int beat, int octave, int startTime, int volume, int instrument) {
