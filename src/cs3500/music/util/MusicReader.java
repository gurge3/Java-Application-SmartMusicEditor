...
public class MusicReader {
   ...
   * @param <MusicCreatorOperations> The main model interface type describing music compositions
   */
  public static <MusicCreatorOperations> MusicCreatorOperations
      parseFile(Readable readable, CompositionBuilder<MusicCreatorOperations> piece) {
      ...
      switch (lineType) {
        ...
        case "repeat":
          try {
            ...
            piece.addRepeatSymbol(type, beat);
